...
struct FFTDataGenerator
{
    ...
    void changeOrder(FFTOrder newOrder)
    {
        ...
        //things that need recreating should ble created on the heap via std::make_unique<>
...
struct AnalyzerPathGenerator
{
        ...
        float negativeInfinity)
    {
        ...
        PathType p;
        p.preallocateSpace(2 * (int)fftBounds.getWidth());
        ...
        const int pathResolution = 2;   //you can draw lines to every pathResolution pixels
